...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        // Moj Prídavok //////////////////////////////////////////////////////////////////
        public static Vector3 GetMouseWorldPosition(float cameraZ)
        {
            var mousePos = Input.mousePosition;
            mousePos.z = cameraZ; // select distance = x units from the camera
            Vector3 vec = GetMouseWorldPositionWithZ(mousePos, Camera.main);
            vec.z = 0f;
            return vec;
        }
        public static Vector3 GetMouseWorldPosition3D(float cameraZ)
        {
